...
export function OperationalHighlights() {
  ...
  useSectionReveal(sectionRef, {
    targets: ['.operational-intro', '.operational-check'],
    y: 56,
    stagger: 0.14,
    from: { y: 72, opacity: 0, clipPath: 'inset(20% 0% 20% 0%)' },
    to: { y: 0, opacity: 1, clipPath: 'inset(0% 0% 0% 0%)', duration: 0.9, ease: 'power3.out' },
  });

  useScrollParallax(logoRef, {
    intensity: 70,
    ease: 'sine.out',
    scrub: 1.2,
  });
  ...
  return (
    <section ref={sectionRef} className="mt-24 mx-auto max-w-7xl px-6 sm:px-10 lg:px-16">
      ...
      {/* Títulos da Secção */}
      <div className="operational-intro mb-10 text-center">
