...
export default function ContactEmailPage() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-12 px-6 pb-24 pt-10 sm:px-10 lg:px-16">
        <div>
          <Link 
            to="/contato" 
            className="inline-flex items-center gap-2 text-sm font-semibold text-neutral-500 hover:text-primary transition-colors dark:text-neutral-400 dark:hover:text-accent"
          >
            <ArrowLeftIcon className="h-4 w-4" />
            Voltar para opções de contato
          </Link>
        </div>
        <section ref={heroRef} className="grid gap-12 lg:grid-cols-[1.15fr_1fr]">
          <div className="space-y-10">
            <div className="space-y-6">
              <p className="contact-kicker text-xs uppercase tracking-[0.4em] text-primary">Discovery call ou Mensagem</p>
              <h1 className="contact-headline text-4xl font-semibold text-neutral-900 dark:text-neutral-50">
                Vamos estruturar sua demanda com a equipe MIRAGE.
              </h1>
              <p className="contact-description max-w-xl text-sm text-neutral-600 dark:text-neutral-300">
                Compartilhe contexto sobre produto, área e métricas preenchendo o formulário abaixo. Retornaremos em até 12 horas úteis com uma agenda
                inteligente.
              </p>
            </div>
